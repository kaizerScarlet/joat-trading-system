...
def test_register_trade_win_updates_all_modules():
    engine = DynamicRiskEngine(initial_balance=1000, max_risk_per_trade=0.02)
...
def test_position_size_scaling():
    engine = DynamicRiskEngine(initial_balance=1000, max_risk_per_trade=0.01)
...
def test_engine_reset():
    engine = DynamicRiskEngine(initial_balance=500, max_risk_per_trade=0.05)
    engine.register_trade(
        pnl = -100.0,
        risk = 50.0,
        reward = 100,
