...
class ExecutionCoordinator:
    ...
    def __init__(
            ...
            cancel_density_scorer: CancelDensityDetectionProtocol,
            synthetic_fill_scorer: SyntheticFillDetectorProtocol,
            iceberg_scorer: OrderIcebergDetectionProtocol,
            laddering_scorer: OrderLadderingDetectionProtocol,
            cancel_spoofing_scorer: OrderSpoofingDetectionProtocol,
